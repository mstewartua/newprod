 ...
 * Member View
 */
class TrackclubsViewmember extends JViewLegacy
{
	/**
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('Member :: New') : JText::_('Member :: Edit'), 'member');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('Member :: New :: Administrator') : JText::_('Member :: Edit :: Administrator'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_trackclubs/views/member/submitbutton.js");
		JText::script('member not acceptable. Error');
	}
}
?>