...
class TrackclubsStyle
{
	function load()
	{
		...
		//stylesheets
		$document->addStylesheet(JURI::base().'components/com_trackclubs/assets/css/trackclubs.css');

		//javascripts
		$document->addScript(JURI::base().'components/com_trackclubs/assets/js/trackclubs.js');
