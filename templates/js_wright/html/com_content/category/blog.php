...
// Wright v.3: Layout options for the moreitmes and subcaterogies modules, (active, global container class, div span class 1,2,3 etc for the (1) moreitems and the (2)subcategories on a row oriented layout).
