...
/**
 * Trackclubs Controller Trackclub
 */
class TrackclubsControllertrackclub extends JControllerForm
{
	public function __construct($config = array())
	{
		$this->view_list = 'trackclubs'; // safeguard for setting the return view listing to the main view.
