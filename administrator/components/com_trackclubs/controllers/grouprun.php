...
/**
 * Groupruns Controller Grouprun
 */
class TrackclubsControllergrouprun extends JControllerForm
{
	public function __construct($config = array())
	{
		$this->view_list = 'groupruns'; // safeguard for setting the return view listing to the main view.
